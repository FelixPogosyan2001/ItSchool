<?php 
include ("BD.php");
$all = mysqli_query($connection,"SELECT * FROM `books` WHERE `id`=1");
$array = mysqli_fetch_assoc($all);
$all2 = mysqli_query($connection,"SELECT * FROM `books` WHERE `id`=2");
$array2 = mysqli_fetch_assoc($all2);
$all3 = mysqli_query($connection,"SELECT * FROM `books` WHERE `id`=3");
$array3 = mysqli_fetch_assoc($all3);
$all4 = mysqli_query($connection,"SELECT * FROM `books` WHERE `id`=4");
$array4 = mysqli_fetch_assoc($all4);
$all5 = mysqli_query($connection,"SELECT * FROM `books` WHERE `id`=5");
$array5 = mysqli_fetch_assoc($all5);
?>
<html>
<head>
	<meta charset ="utf-8">
...
setTimeout(function(){window.location="books.php";},0600);
}
	</script>
</head>
<body style="background: #000000 linear-gradient(45deg, #7e67e5, #02cbdf); color: #c3e9f5;">
...
<div class="row" style="margin:none;margin-left:20px">
<div class="col-lg-2" style="padding-left:4px;margin-bottom:15px;">
<div style=" background: rgba(255, 255, 255, 0.08);border: 1px solid rgba(255, 255, 255, 0.4);border-radius:10px;">
	<h4 style="padding-left:8px;border-bottom:2px solid white"><?=$array['header']?></h4>
	<center><img src="<?=$array['image'] ?>" style="width:150px;height:200px"/></center>
	<p style="padding:8px;border-bottom:2px solid white"><?echo $array['body']?></p>
	<center><button style="font-size:120%;" class="btn btn-info"><a href="<?=$array['download']?>" style="color:white;text-decoration:none" download>Скачать</a></button></center>
</div>
</div>
<div class="col-lg-2" style="padding-left:4px;margin-bottom:15px;">
<div style=" background: rgba(255, 255, 255, 0.08);border: 1px solid rgba(255, 255, 255, 0.4);border-radius:10px;">
	<h4 style="padding-left:8px;border-bottom:2px solid white"><?=$array2['header']?></h4>
	<center><img src="<?=$array2['image'] ?>" style="width:150px;height:200px"/></center>
	<p style="padding:8px;border-bottom:2px solid white"><?echo $array2['body']?></p>
	<center><button style="font-size:120%;" class="btn btn-info"><a href="<?=$array2['download']?>" style="color:white;text-decoration:none" download>Скачать</a></button></center>
</div>
</div>
<div class="col-lg-2" style="padding-left:4px;margin-bottom:15px;">
<div style=" background: rgba(255, 255, 255, 0.08);border: 1px solid rgba(255, 255, 255, 0.4);border-radius:10px;">
	<center><h4 style="padding-left:8px;border-bottom:2px solid white"><?=$array3['header']?></h4></center>
	<center><img src="<?=$array3['image']?>" style="width:150px;height:200px;"/></center>
	<p style="padding:8px;border-bottom:2px solid white"><?=$array3['body']?></p>
	<center><button style="font-size:120%;" class="btn btn-info"><a href="<?=$array3['download']?>" style="color:white;text-decoration:none" download>Скачать</a></button></center>
</div>
</div>
<div class="col-lg-2" style="padding-left:4px;margin-bottom:15px;">
<div style=" background: rgba(255, 255, 255, 0.08);border: 1px solid rgba(255, 255, 255, 0.4);border-radius:10px;">
	<center><h4 style="padding-left:8px;border-bottom:2px solid white"><?=$array4['header']?></h4></center>
	<center><img src="<?=$array4['image']?>" style="width:150px;height:200px;"/></center>
	<p style="padding:8px;border-bottom:2px solid white"><?=$array4['body']?></p>
	<center><button style="font-size:120%;" class="btn btn-info"><a href="b<?=$array4['download']?>" style="color:white;text-decoration:none" download>Скачать</a></button></center>
</div>
</div>
<div class="col-lg-2" style="padding-left:4px;margin-bottom:15px;">
<div style=" background: rgba(255, 255, 255, 0.08);border: 1px solid rgba(255, 255, 255, 0.4);border-radius:10px;">
	<center><h4 style="padding-left:8px;border-bottom:2px solid white"><?=$array5['header']?></h4></center>
	<center><img src="<?=$array5['image']?>" style="width:150px;height:200px;"/></center>
	<p style="padding:8px;border-bottom:2px solid white"><?=$array5['body']?></p>
	<center><button style="font-size:120%;" class="btn btn-info"><a href="<?=$array5['download']?>" style="color:white;text-decoration:none" download>Скачать</a></button></center>
</div>
</div>
</div>
</div>
<footer class ="container-fluid" style = "color:white;margin-top:13px;background:url('image/fon.jpg')">
